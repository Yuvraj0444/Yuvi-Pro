...
CREATE TABLE IF NOT EXISTS fare_classes (
    ...
    CONSTRAINT fk_fare_flight FOREIGN KEY (flight_id) REFERENCES flights(flight_id)
);
...
INSERT INTO airports (iata_code, name, city, country, timezone) VALUES
  ...
  ('GRU', 'São Paulo-Guarulhos International',   'São Paulo',      'BR', 'America/Sao_Paulo'),
